...
/**
 * Registers a column of type [ULIDColumnType] with the specified name and serializer.
 *
...
/**
 * Registers a column of type [ULIDColumnType] with the specified name and serializer and automatically generates ULID values.
 *
 * @param T The type of the ULID data.
 * @param ulidGenerator A lambda function used to generate ULID values for the column.
 * @return The registered column.
 */
